...
public class LGEssEnervuBindingConstants {
    ...
    public static boolean EMPTYBATTERY_ALREADY_TRIGGERED = false;
    public static boolean LOWBATTERY_ALREADY_TRIGGERED = false;
    public static boolean FULLBATTERY_ALREADY_TRIGGERED = false;
    public static boolean GENPOWERTHRESHOLD_ALREADY_TRIGGERED = false;
    public static boolean GENPOWERTHRESHOLD_RESET_TRIGGER = false;
    public static int CURRENT_GENERATED_POWER = 0;
    ...
    public static final String CHANNEL_BATTERY_LOW = "lowbattery";

    public static final String CHANNEL_TRIGGER_BATTERYSTATUS = "trigger_battery_status";
    ...
    // comfort
    public static final String CHANNEL_TRIGGER_POWERPRODUCTIONABOVETHRESHOLD = "trigger_powergen_status";
}
