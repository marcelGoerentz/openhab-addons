...
public class CoResult {
    ...
    @Expose
    private Integer essId = 0;
    @SerializedName("essSerialNo")
    @Expose
    private Object essSerialNo = "0";
    @SerializedName("targetDate")
    @Expose
    private Object targetDate = "0";
    @SerializedName("yyyymmdd")
    @Expose
    private Object yyyymmdd = "0";
    @SerializedName("hhmm")
    @Expose
    private Object hhmm = "0";
    @SerializedName("string1E")
    @Expose
    private Double string1E = 0.0;
    @SerializedName("string1P")
    @Expose
    private Double string1P = 0.0;
    @SerializedName("string2E")
    @Expose
    private Double string2E = 0.0;
    @SerializedName("string2P")
    @Expose
    private Double string2P = 0.0;
    @SerializedName("string3E")
    @Expose
    private Double string3E = 0.0;
    @SerializedName("string3P")
    @Expose
    private Double string3P = 0.0;
    @SerializedName("string4E")
    @Expose
    private Double string4E = 0.0;
    @SerializedName("string4P")
    @Expose
    private Double string4P = 0.0;
    @SerializedName("string5E")
    @Expose
    private Double string5E = 0.0;
    @SerializedName("string5P")
    @Expose
    private Double string5P = 0.0;
    @SerializedName("directConsumpE")
    @Expose
    private Double directConsumpE = 0.0;
    @SerializedName("directConsumpP")
    @Expose
    private Double directConsumpP = 0.0;
    @SerializedName("battSoc")
    @Expose
    private Double battSoc = 0.0;
    @SerializedName("batt1Chg")
    @Expose
    private Double batt1Chg = 0.0;
    @SerializedName("batt1Dis")
    @Expose
    private Double batt1Dis = 0.0;
    @SerializedName("batt1Soc")
    @Expose
    private Double batt1Soc = 0.0;
    @SerializedName("batt1Tmp")
    @Expose
    private Double batt1Tmp = 0.0;
    @SerializedName("batt1P")
    @Expose
    private Double batt1P = 0.0;
    @SerializedName("batt1ChgP")
    @Expose
    private Double batt1ChgP = 0.0;
    @SerializedName("batt1DisP")
    @Expose
    private Double batt1DisP = 0.0;
    @SerializedName("batt2Chg")
    @Expose
    private Double batt2Chg = 0.0;
    @SerializedName("batt2Dis")
    @Expose
    private Double batt2Dis = 0.0;
    @SerializedName("batt2Soc")
    @Expose
    private Double batt2Soc = 0.0;
    @SerializedName("batt2Tmp")
    @Expose
    private Double batt2Tmp = 0.0;
    @SerializedName("batt2P")
    @Expose
    private Double batt2P = 0.0;
    @SerializedName("batt2ChgP")
    @Expose
    private Double batt2ChgP = 0.0;
    @SerializedName("batt2DisP")
    @Expose
    private Double batt2DisP = 0.0;
    @SerializedName("batt3Chg")
    @Expose
    private Double batt3Chg = 0.0;
    @SerializedName("batt3Dis")
    @Expose
    private Double batt3Dis = 0.0;
    @SerializedName("batt3Soc")
    @Expose
    private Double batt3Soc = 0.0;
    @SerializedName("batt3Tmp")
    @Expose
    private Double batt3Tmp = 0.0;
    @SerializedName("batt3P")
    @Expose
    private Double batt3P = 0.0;
    @SerializedName("batt3ChgP")
    @Expose
    private Double batt3ChgP = 0.0;
    @SerializedName("batt3DisP")
    @Expose
    private Double batt3DisP = 0.0;
    @SerializedName("batt4Chg")
    @Expose
    private Double batt4Chg = 0.0;
    @SerializedName("batt4Dis")
    @Expose
    private Double batt4Dis = 0.0;
    @SerializedName("batt4Soc")
    @Expose
    private Double batt4Soc = 0.0;
    @SerializedName("batt4Tmp")
    @Expose
    private Double batt4Tmp = 0.0;
    @SerializedName("batt4P")
    @Expose
    private Double batt4P = 0.0;
    @SerializedName("batt4ChgP")
    @Expose
    private Double batt4ChgP = 0.0;
    @SerializedName("batt4DisP")
    @Expose
    private Double batt4DisP = 0.0;
    @SerializedName("batt5Chg")
    @Expose
    private Double batt5Chg = 0.0;
    @SerializedName("batt5Dis")
    @Expose
    private Double batt5Dis = 0.0;
    @SerializedName("batt5Soc")
    @Expose
    private Double batt5Soc = 0.0;
    @SerializedName("batt5Tmp")
    @Expose
    private Double batt5Tmp = 0.0;
    @SerializedName("batt5P")
    @Expose
    private Double batt5P = 0.0;
    @SerializedName("batt5ChgP")
    @Expose
    private Double batt5ChgP = 0.0;
    @SerializedName("batt5DisP")
    @Expose
    private Double batt5DisP = 0.0;
    @SerializedName("consumptionE")
    @Expose
    private Double consumptionE = 0.0;
    @SerializedName("consumptionP")
    @Expose
    private Double consumptionP = 0.0;
    @SerializedName("gridPSell")
    @Expose
    private Double gridPSell = 0.0;
    @SerializedName("gridPBuy")
    @Expose
    private Double gridPBuy = 0.0;
    @SerializedName("gridESell")
    @Expose
    private Double gridESell = 0.0;
    @SerializedName("gridEBuy")
    @Expose
    private Double gridEBuy = 0.0;
    @SerializedName("battChg")
    @Expose
    private Double battChg = 0.0;
    @SerializedName("battDis")
    @Expose
    private Double battDis = 0.0;
    @SerializedName("totalBattChg")
    @Expose
    private Double totalBattChg = 0.0;
    @SerializedName("totalBattDis")
    @Expose
    private Double totalBattDis = 0.0;
    @SerializedName("totalGridESell")
    @Expose
    private Double totalGridESell = 0.0;
    @SerializedName("totalGridEBuy")
    @Expose
    private Double totalGridEBuy = 0.0;
    @SerializedName("totalDirectConsumpE")
    @Expose
    private Double totalDirectConsumpE = 0.0;
    @SerializedName("totalConsumpE")
    @Expose
    private Double totalConsumpE = 0.0;
    @SerializedName("totalPvE")
    @Expose
    private Double totalPvE = 0.0;
    @SerializedName("limitGridPSell")
    @Expose
    private Double limitGridPSell = 0.0;
    @SerializedName("limitGridPSellPercent")
    @Expose
    private Double limitGridPSellPercent = 0.0;
    @SerializedName("pvP")
    @Expose
    private Double pvP = 0.0;
    @SerializedName("battP")
    @Expose
    private Double battP = 0.0;
    @SerializedName("battChgP")
    @Expose
    private Double battChgP = 0.0;
    @SerializedName("battDisP")
    @Expose
    private Double battDisP = 0.0;
    @SerializedName("pvDcOut")
    @Expose
    private Double pvDcOut = 0.0;
    ...
    @Expose
    private Integer winterModeSocLimit = 0;
    @SerializedName("role")
    @Expose
    private Object role = "";
    @SerializedName("companyAuth")
    @Expose
    private Integer companyAuth = 0;
    @SerializedName("installerId")
    @Expose
    private Integer installerId = 0;
    @SerializedName("country")
    @Expose
    private Object country = "";
    @SerializedName("currentPvP")
    @Expose
    private Double currentPvP = 0.0;
    @SerializedName("currentBattP")
    @Expose
    private Double currentBattP = 0.0;
    @SerializedName("currentLoadP")
    @Expose
    private Double currentLoadP = 0.0;
    @SerializedName("currentGridP")
    @Expose
    private Double currentGridP = 0.0;
    @SerializedName("currentDirectConsumption")
    @Expose
    private Integer currentDirectConsumption = 0;
    @SerializedName("currentBattChg")
    @Expose
    private Integer currentBattChg = 0;
    @SerializedName("currentBattDis")
    @Expose
    private Integer currentBattDis = 0;
    @SerializedName("currentGridSell")
    @Expose
    private Integer currentGridSell = 0;
    @SerializedName("currentGridBuy")
    @Expose
    private Integer currentGridBuy = 0;
    @SerializedName("currentChgFromGrid")
    @Expose
    private Integer currentChgFromGrid = 0;
