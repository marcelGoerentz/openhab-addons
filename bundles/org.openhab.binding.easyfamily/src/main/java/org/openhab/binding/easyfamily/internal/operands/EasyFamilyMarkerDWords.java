 ...
 */
@NonNullByDefault
public class EasyFamilyMarkerDWords extends EasyFamilyWriteableOperand {

    EasyFamilyMarkerDWords(int number, ChannelUID uid) {
        super(CHANNEL_MARKER_DWORDS, number, uid);
    }
